...
using AdaptiveCardsHelpBot.Dialogs.Greeting;
using AdaptiveCardsHelpBot.SimpleResponses;
...
namespace Microsoft.BotBuilderSamples
{
    ...
    /// </summary>
    public class AdaptiveCardsHelpBot : IBot
    {
        ...
        public const string FeatureSupportIntent = "FeatureSupport";
        public const string DesignCardIntent = "DesignCard";
        public const string HostVersionIntent = "HostVersion";

        /// <summary>
        /// Key in the bot config (.bot file) for the LUIS instance.
        /// In the .bot file, multiple instances of LUIS can be configured.
        /// </summary>
        public static readonly string LuisConfiguration = "AdaptiveCardsHelpBotLuisApplication";
                ...
                if (!dc.Context.Responded)
                {
                    ...
                    switch (dialogResult.Status)
                    {
                        case DialogTurnStatus.Empty:
                            switch (topIntent)
                            {
                                case DesignCardIntent:
                                    await dc.BeginDialogAsync(nameof(DesignCardDialog));
                                    break;

                                case HostVersionIntent:
                                    await HostVersionResponse.RespondAsync(dc, luisResults);
                                    break;
